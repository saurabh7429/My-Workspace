/*Write a program to create class rectangle with length, width and,
height data member of class and find the area and volume of
rectangle using constructor and destructor.
(use default, parametrized and copy constructor)*/
